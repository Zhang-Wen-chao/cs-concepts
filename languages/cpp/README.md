...
> 目标：从零基础到能讲清机制、写出现代 C++、从容应对 C++ 面试  
> 路径：8 阶段渐进，每阶段"理论 + 实战"配对
...
| 3 | 面向对象深入 | 虚函数表怎么工作？ | `03_oop_deep_dive/` |
| 4 | 模板与泛型 | 模板怎么实例化？ | `04_templates/` |
| 5 | STL 源码级 | vector / unordered_map 怎么实现？ | `05_stl_internals/` |
| 6 | 现代 C++ 特性 | C++11/14/17/20 怎么用对？ | `06_modern_cpp/` |
| 7 | 并发与内存序 | 内存序是怎么回事？ | `07_concurrency/` |

> 注：原 01-04 阶段笔记（modern_cpp_basics / concurrency / system_programming / projects）已并入新路线，作为深入实战内容保留。

**学习节奏**：
- 每阶段 1-3 天，每天 1-2 小时
- 每个子主题 = 1 篇笔记 + 1 段可编译代码
- 学完一节立刻跑代码验证，"编译通过 ≠ 懂了"
